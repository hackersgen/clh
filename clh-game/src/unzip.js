...
decompress(
  ...
  "assets/models/CLH_Computer.mtl"
);
decompress(
  "assets/models/CLH_Computer.obj.gz",
  "assets/models/CLH_Computer.obj"
);
decompress(
  "assets/models/CLH_ep2_computer_high_poly.mtl.gz",
  "assets/models/CLH_ep2_computer_high_poly.mtl"
);
decompress(
  "assets/models/CLH_ep2_computer_high_poly.obj.gz",
  "assets/models/CLH_ep2_computer_high_poly.obj"
);
decompress(
  "assets/models/CLH_ep2_cyc_wall.mtl.gz",
  "assets/models/CLH_ep2_cyc_wall.mtl"
);
decompress(
  "assets/models/CLH_ep2_cyc_wall.obj.gz",
  "assets/models/CLH_ep2_cyc_wall.obj"
);
